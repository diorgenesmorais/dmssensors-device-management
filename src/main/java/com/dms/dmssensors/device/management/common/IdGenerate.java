package com.dms.dmssensors.device.management.common;
...
public class IdGenerate {
    ...
    static {
        Optional.ofNullable(System.getenv("tsid.node"))
                .ifPresent(tsidNode -> {
                    System.setProperty("tsid.node", tsidNode);
                });
        Optional.ofNullable(System.getenv("tsid.node.count"))
                .ifPresent(tsidNodeCount -> {
                    System.setProperty("tsid.node.count", tsidNodeCount);
                });
